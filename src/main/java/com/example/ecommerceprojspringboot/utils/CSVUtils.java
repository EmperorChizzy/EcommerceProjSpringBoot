package com.example.ecommerceprojspringboot.utils;

import at.favre.lib.crypto.bcrypt.BCrypt;
import com.example.ecommerceprojspringboot.models.Product;
import com.example.ecommerceprojspringboot.models.Users;
import com.example.ecommerceprojspringboot.repositories.ProductRepositories;
...
public class CSVUtils {
    ...
    public void readUserCSV(){
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/main/java/com/example/ecommerceprojspringboot/users.csv"))) {
            String line;
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/main/java/com/example/ecommerceprojspringboot/product.csv"))) {
            String line;
            boolean lineOne = false;
            while ((line=bufferedReader.readLine())!=null){
